                        ...
                        <?php
                          ...
                          while($row = $select -> fetch(PDO::FETCH_OBJ)){
                            ...
                            <td>
                              ...
                              <td>
                              <a href="editorderuser.php?id='.$row->invoice_id.'" class="btn btn-info" role="button"><span class="glyphicon glyphicon-edit" style="color:#ffffff" data-toggle="tooltip" title="Edit"></span></a>
                              </td>
